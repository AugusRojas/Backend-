...
CREATE TABLE IF NOT EXISTS `reservacionesbar`.`carta` (
  ...
  PRIMARY KEY (`idMenus`),
  INDEX `fk_menus_bebidas1_idx` (`idBebidas` ASC) VISIBLE,
  INDEX `fk_menus_comidas1_idx` (`idComidas` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_menus_comidas1`
    ...
    REFERENCES `reservacionesbar`.`comidas` (`idComida`))
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `reservacionesbar`.`reservaciones` (
  ...
  `cantidadReservacion` INT NULL DEFAULT NULL,
  `idMesas` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `reservacionesbar`.`mesas` (
  ...
  `cantidadMesas` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `reservacionesbar`.`mozos` (
  ...
  PRIMARY KEY (`idMozo`),
  INDEX `fk_idSector_idx` (`idSector` ASC) VISIBLE,
